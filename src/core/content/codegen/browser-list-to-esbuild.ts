/**
 * Code from https://github.com/marcofugaro/browserslist-to-esbuild/blob/main/src/index.js
 */
import browserslist, { LoadConfigOptions } from 'browserslist'

// convert the browserslist field in package.json to
// esbuild compatible array of browsers
export default function browserslistToEsbuild(browserslistConfig: string[] | undefined, options: LoadConfigOptions = {}) {
